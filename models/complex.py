...
COMPLEX_MODELS = ["ComplEx", "RotatE", "QuintComplEx", "QuintRotatE", "QuadComplEx", "QuadRotatE"]
...
class QuadComplEx(BaseC):
    """Simple complex model http://proceedings.mlr.press/v48/trouillon16.pdf"""

    def get_queries(self, queries):
        """Compute embedding and biases of queries."""
        head_e, rel_e, tim_e, _ = self.get_complex_embeddings_time(queries)

        hr_R = head_e[0] * rel_e[0] - head_e[1] * rel_e[1]
        hr_I = head_e[0] * rel_e[1] + head_e[1] * rel_e[0]
...
class QuintComplEx(BaseC):
    """Simple complex model http://proceedings.mlr.press/v48/trouillon16.pdf"""

    def get_queries(self, queries):
        """Compute embedding and biases of queries."""
        head_e, rel_e, loc_e, tim_e, _ = self.get_complex_embeddings_space_time(queries)

        hr_R = head_e[0] * rel_e[0] - head_e[1] * rel_e[1]
        hr_I = head_e[0] * rel_e[1] + head_e[1] * rel_e[0]

        lt_R = loc_e[0] * tim_e[0] - loc_e[1] * tim_e[1]
        lt_I = loc_e[0] * tim_e[1] + loc_e[1] * tim_e[0]
...
class QuadRotatE(BaseC):
    ...
    def get_queries(self, queries):
        ...
        hr_R = head_e[0] * cos - head_e[1] * sin
        hr_I = head_e[0] * sin + head_e[1] * cos
